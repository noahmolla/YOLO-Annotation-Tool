@echo off
REM ============================================
REM YOLO Label Compare Viewer - Auto-Setup
REM ============================================
setlocal
...
set "PYTHON_EXE="
set "REG_PYTHON_EXE="
set "ENTRY_POINT=label_compare_viewer\main.py"
...
echo.
echo ========================================
echo   YOLO Label Compare Viewer
echo ========================================
echo.
...
python -c "import ttkbootstrap, PIL, yaml, openai, dotenv, numpy, cv2" >nul 2>&1
if errorlevel 1 (
    echo.
